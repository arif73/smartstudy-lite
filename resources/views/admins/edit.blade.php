        ...
        <div class="row">
            ...
            <div class="card">
                <div class="content">
                    ...
                    @endif
                    <form action="{{ route('postEditAdmin') }}" role="form" method="POST" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group{{ $errors->has('about') ? ' has-error' : '' }}">
                                    ...
                                    <textarea rows="3" id="about" type="text" class="form-control border-input" placeholder="Here can be your description" name="about">{{$admin->about}}</textarea>
                                    @if ($errors->has('about'))
                                        <span class="help-block">
