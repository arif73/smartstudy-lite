        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">@yield('page-name')</a>
                </div>
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li>
                            <img src="../uploads/avatars/{{Auth::user()->avatar}}" style="width:32px;height:32px;border-radius: 50%;top:20px;left:10px;position:absolute;">
                        </li>
...
&copy; <script>document.write(new Date().getFullYear())</script>, Developed by <a href="http://www.reverb.com.bd">Reverb Limited</a>
</div>
</div>
</footer>
