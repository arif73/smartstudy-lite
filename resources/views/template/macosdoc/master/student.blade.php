...
<div id="dock-container" style="position: fixed; padding-top: 20px; bottom: 0%;  background: #ffffff;">
    <ul>
        ...
        <li>
            <span>Dashboard</span>
            <a href="{{route('student.dashboard')}}"><img src="{{getenv('baseurl')}}/assets/img/rooms.png"/></a></li>
        </li>

        <li>
            <span>Class Routine</span>
            <a href="{{route('student.routine')}}"><img src="{{getenv('baseurl')}}/assets/img/routine.png"/></a></li>
        </li>
        <li>
            <span>Attendance</span>
            <a href="{{ route('attendence.student') }}"><img src="{{getenv('baseurl')}}/assets/img/attendance.png"/></a>
        </li>
        
         <li>
            <span>Result</span>
            <a href="{{ route('result.student') }}"><img src="{{getenv('baseurl')}}/assets/img/self-attendance.png"/></a>
        </li>
        
        <li>
            <span>Notice</span>
            <a href="{{ route('notice.student.index') }}"><img src="{{getenv('baseurl')}}/assets/img/notice.png"/></a>
        </li>

        <li>
            <span>News</span>
            <a href="{{ route('news.student.index') }}"><img src="{{getenv('baseurl')}}/assets/img/news.png"/></a>
        </li>
        <li>
            <span>Profile</span>
            <a href="{{route('student.profile')}}"><img src="{{getenv('baseurl')}}/assets/img/profile.png"/></a>
        </li>


        <li>
            <span>Events</span>
            <a href="{{ route('events.student.index') }}"><img src="{{getenv('baseurl')}}/assets/img/events.png"/></a>
        </li>
        <li>
            <span>Logout</span>
            <a href="{{ route('logout') }}"
    ...
    <div class="container">
        <div class="navbar-header">
            <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navcol-2">
                ...
                <span class="icon-bar"></span>
                <span class="icon-bar"></span>
            </button><a class="navbar-brand navbar-link" href="{{route('student.dashboard')}}"><span class="glyphicon glyphicon-phone"></span><strong>STUDENT</strong> PANEL @yield('page-name')</a></div>
